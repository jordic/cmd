...
(custom-set-variables
 ...
 '(safe-local-variable-values
   (quote
    ((pony-settings
      (make-pony-project :python "/home/jordi/Documents/transtic/env/bin/python" :pythonpath "/home/david/megacorp/libs/projectzero" :settings "transtic.settings.testing" :appsdir "./")))))
 '(tool-bar-mode nil)
