...
export PATH=$PATH:/usr/local/go/bin:~/bin:~/go/bin:/opt/plan9/bin
export GOPATH=/home/jordi/go

PLAN9=/opt/plan9 export PLAN9
PATH=$PATH:$PLAN9/bin export PATH
export MOUSESCROLLSIZE=5;
export EDITOR=vim
export PAGER=less
...
togo() {
	cd /home/jordi/go/src/github.com/jordic/
}
[ -f ~/.fzf.bash ] && source ~/.fzf.bash


showmenu() {
	dmenu_run -i -fn 'Menlo Regular-12' -nb '#9eeeee' -nf '#000000' -sb '#175e5f' -sf '#9eeeee'
}
...
source '/home/jordi/google-cloud-sdk/path.bash.inc'
